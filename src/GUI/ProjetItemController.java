   ...
   tf_note.setRating(p.getNote()); 
    ...
    private void Submit_btn(ActionEvent event) {
      /*  try {
            ...
            String requete="insert into projets (note) value (?)";
            projetservices=cnx.cnx.prepareStatement(requete); 
            projetservice.setNote(1,(int)tf_note.getRating());
        } catch (SQLException ex) {
            Logger.getLogger(ProjetItemController.class.getName()).log(Level.SEVERE, null, ex);
        }*/
